...
export Filtered_Leapfrog,
    Update_Init_Step!, Get_Δt, Get_ξ, Compute_Spectral_Damping!, Filtered_Leapfrog!
...
function Compute_Spectral_Damping!(
    ...
    Qc::AbstractArray{ComplexF64,3},
    Qp::AbstractArray{ComplexF64,3},
