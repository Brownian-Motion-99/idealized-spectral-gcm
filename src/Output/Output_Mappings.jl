...
function Get_Var_Info(::Val{:PrimitiveEquation})
    base_dict = Dict{Symbol, VarMeta}(
        ...
        :t_eq   => VarMeta("teq",    "K",          "Held-Suarez Equilibrium Temperature", "held_suarez_equilibrium_temperature",       3),
        :lnps   => VarMeta("lnps",   "1",          "Logarithm of Surface Pressure",       "log_surface_air_pressure",                  2),
        # Tendencies
        :du     => VarMeta("dua_dt",  "m s-2",     "Tendency of Eastward Wind",           "tendency_of_eastward_wind",                 3),
        :dv     => VarMeta("dva_dt",  "m s-2",     "Tendency of Northward Wind",          "tendency_of_northward_wind",                3),
        :dt     => VarMeta("dta_dt",  "K s-1",     "Tendency of Air Temperature",         "tendency_of_air_temperature",               3),
        :dvor   => VarMeta("dvor_dt", "s-2",       "Tendency of Relative Vorticity",      "tendency_of_atmosphere_relative_vorticity", 3),
        :ddiv   => VarMeta("ddiv_dt", "s-2",       "Tendency of Divergence",              "tendency_of_divergence_of_wind",            3),
        :dps    => VarMeta("dps_dt",  "Pa s-1",    "Tendency of Surface Pressure",        "tendency_of_surface_air_pressure",          2),
        :dq     => VarMeta("dq_dt",   "s-1",       "Tendency of Specific Humidity",       "tendency_of_specific_humidity",             3)
    )
...
function Get_Var_Info(::Val{:Barotropic})
    return Dict{Symbol, VarMeta}(
        :vor  => VarMeta("vor",  "s-1",    "Relative Vorticity", "atmosphere_relative_vorticity",             2),
        ...
        :dvor => VarMeta("dvor", "s-2",    "Vorticity Tendency", "tendency_of_atmosphere_relative_vorticity", 2)
    )
end
...
function Get_Var_Info(::Val{:ShallowWater})
    return Dict{Symbol, VarMeta}(
        ...
        :pv   => VarMeta("pv",     "m-1 s-1", "Potential Vorticity", "atmosphere_potential_vorticity",  2),
        :dh   => VarMeta("dh_dt",  "m s-1",   "Height Tendency",     "tendency_of_geopotential_height", 2)
    )
end
