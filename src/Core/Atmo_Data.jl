...
function Atmo_Data(
    ...
    do_mass_correction::Bool, do_energy_correction::Bool, do_water_correction::Bool, use_virtual_temperature::Bool, L::Float64,
    ...
    Atmo_Data(
        ...
        radius, omega, grav, rdgas, kappa, rvgas, cp_air, Lv, L, gamma, alpha,
        coriolis
    )
end
