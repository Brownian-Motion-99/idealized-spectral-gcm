...
mutable struct Dyn_Data
    ...
    tracer_workspace::Grid_Tracer_Workspace
...
"""
    Dyn_Data(name, num_fourier, num_spherical, nλ, nθ, nd)
...
function Dyn_Data(
    ...
    # surface heat flux
    grid_shflx = zeros(Float64, nλ, nθ, 1)
    grid_lhflx = zeros(Float64, nλ, nθ, 1)

    # precipitation
    grid_liquid_water_content = zeros(Float64, nλ, nθ, nd)
    grid_precip = zeros(Float64, nλ, nθ, 1)
    ...
    tracer_workspace = Grid_Tracer_Workspace(nλ, nθ, nd)
